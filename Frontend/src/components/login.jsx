...
function Login() {
    ...
    async function ForgetPassword() {
        if (! newPassword === newPasswordAgain) {
            ...
            axios.post('https://ToDoList.Masterpythonanywhere.com/api/forget_password/', {
    ...
    async function ResetPassword() {
        ...
        if (otp != readOtp) {
            axios.patch('https://ToDoList.Masterpythonanywhere.com/api/reset_password/' + resetUsername, {
    ...
    async function submit() {
        if (username == '' || password == '') {
            ...
            let response = await axios.post('https://ToDoList.Masterpythonanywhere.com/api/login/', {
                'username': username,
                'password': password,
            }).then((response) => {
