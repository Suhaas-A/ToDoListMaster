...
function Home() {
    ...
    async function changeAccessToken() {
        try {
            let response = await axios.post('https://ToDoList.Masterpythonanywhere.com/api/login/refresh/', {
    ...
    async function fetchMyTasks() {
        try {
            let response = await axios.get('https://ToDoList.Masterpythonanywhere.com/api/create_list_task/', {
                headers: {
    ...
    async function deleteTask(task_id) {
        try {
            let response = await axios.delete('https://ToDoList.Masterpythonanywhere.com/api/view_update_delete/' + Number(task_id) + '/', {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
    ...
    async function editTask() {
        try {
            let response = await axios.patch('https://ToDoList.Masterpythonanywhere.com/api/view_update_delete/' + Number(editId) + '/', {'name' : taskName}, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
    ...
    async function markAsCompleted(taskId) {
        try {
            ...
            let response = await axios.patch('https://ToDoList.Masterpythonanywhere.com/api/view_update_delete/' + Number(taskId) + '/', {'fulfilled' : true, 'completion_date': date}, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
    ...
    async function editDueDate() {
        try {
            ...
            let response = await axios.patch('https://ToDoList.Masterpythonanywhere.com/api/view_update_delete/' + Number(dateId) + '/', {'due_date' : format(new Date(dueDate), 'yyyy-MM-dd')}, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
    ...
    async function markAsInComplete(taskId) {
        try {
            let response = await axios.patch('https://ToDoList.Masterpythonanywhere.com/api/view_update_delete/' + Number(taskId) + '/', {'fulfilled': false, 'completion_date': null}, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
    ...
    async function createTask() {
        try {
            let response = await axios.post('https://ToDoList.Masterpythonanywhere.com/api/create_list_task/', {'name': name, 'due_date': format(new Date(date), 'yyyy-MM-dd')}, {
                headers: {
                    Authorization: `Bearer ${sessionStorage.accessToken}`
                }
            });
